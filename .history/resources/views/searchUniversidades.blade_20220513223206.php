                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    @if(auth()->user()->universidades()->count() > 0)
                                        @foreach ( auth()->user()->universidades as $universidades)
                                            @if ($universidades->id == $universidade->id)
                                                <form action="{{ route('universidade_user.destroy', ['universidade_user' => $universidade->id]) }}" method="DELETE" >
                                                    @csrf
                                                <button type="submit" style="background-color: blue;"  name="universidade_id"> Cancelar </button>
                                                </form>
                                            @endif
