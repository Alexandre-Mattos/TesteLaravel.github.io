        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0" >
            <main>
                <div class="search-university">
                    <form class="login-data" action="{{ route('universidade.show')}}" method="POST" >
                        @csrf
                        <div class="div-form">
                            <div class="text-div">
                            ...
                            <div class="password-div" style="padding-bottom: 20px;">
                                <input class="input-field" type="text" name="name" id="name" placeholder="Enter university name" style="padding-bottom: 5px; margin-bottom: 5px" required>
                            </div>
                        </div>
                <div>
