                                    ...
                                    @if(auth()->user()->universidades()->count() > 0)
                                        @foreach ( auth()->user()->universidades as $universidades)
                                            @if ($universidades->id == $universidade->id)
                                                <form action="{{ route('universidade_user.destroy') }}" method="DELETE" >
                                                    @csrf
                                                <button type="submit" style="background-color: blue;"  name="universidade_id" value="{{$universidade->id}}"  > Cancelar </button>
                                                </form>
                                            @endif
