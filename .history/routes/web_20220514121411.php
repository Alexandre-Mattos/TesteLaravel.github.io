...
Route::get('/universidade', UniversidadeController::class . '@index')->name('universidade');
Route::post('/universidade', UniversidadeController::class . '@store')->name('universidade');
